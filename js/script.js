            ...
            async function (event) {
                ...
                try {
                    ...
                    if (data.success) {
                        ...
                        formResult.textContent =
                            "Grazie! Abbiamo ricevuto la tua richiesta. Ti risponderemo appena possibile.";
                        ...
                        formResult.textContent =
                            "Si è verificato un problema durante l'invio. Puoi riprovare oppure contattarci direttamente via WhatsApp o email.";
